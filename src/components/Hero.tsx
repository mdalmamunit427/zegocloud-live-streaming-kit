      ...
      <ScrollAnimationWrapper>
          <motion.div
            ...
            <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
              ...
              Build Interactive Live Streaming and Reach <span className="text-blue-600">Millions Globally</span>
              </h1>
              ...
              <button className="bg-[#7a1be7] hover:bg-indigo-600 py-3 px-8 text-white font-semibold rounded-md hover:-translate-y-2 transition-all duration-200 ease-in">Get Started</button>
            </div>
